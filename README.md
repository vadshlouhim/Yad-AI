...
Stripe doit rester en mode TEST en développement et utiliser exclusivement des
clés/objets LIVE sur Netlify en production. `NEXT_PUBLIC_APP_URL` doit être
l'origine HTTPS publique en production. Le serveur refuse volontairement une
clé TEST en production ou une clé LIVE en développement. Le webhook Stripe est
