...
> = {
  ...
  detailed: {
    ...
    technicalCategoryNames: [
      ...
      "Horaires Chabbat avec office",
      "Horaires Chabbat avec offices",
      "Horaires de Chabbat avec office",
      "Horaires de Chabbat avec offices",
      "horaires_chabbat_detailles",
      "horaires_de_chabbat_detailles",
      "horaires_chabbat_avec_office",
      "horaires_chabbat_avec_offices",
      "horaires_de_chabbat_avec_office",
      "horaires_de_chabbat_avec_offices",
