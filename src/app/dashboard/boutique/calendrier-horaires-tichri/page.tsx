...
import { ArrowLeft, CalendarDays, ExternalLink, MessageCircle } from "lucide-react";
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(420px,1.15fr)] lg:items-center">
          <div className="max-w-xl">
            ...
            <h1 className="mt-5 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
              Calendrier des Horaires de Tichri
            </h1>
            <p className="mt-5 text-base leading-7 text-slate-600 sm:text-lg">
              Découvrez plusieurs exemples de calendriers réunissant les horaires et les temps forts du mois de Tichri.
            </p>
            ...
            <div className="mt-7 rounded-2xl border border-orange-200 bg-white/80 p-4 text-sm leading-6 text-slate-700 shadow-sm backdrop-blur">
              Vous souhaitez obtenir plus d’informations ou préparer votre calendrier ? Contactez-nous directement sur WhatsApp.
            </div>
          ...
          <BoutiqueImageCarousel images={CALENDAR_IMAGES} label="Exemples du calendrier de Tichri" />
        </div>
      </section>
    </div>
  );
