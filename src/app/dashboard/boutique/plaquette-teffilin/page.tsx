        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,0.85fr)_minmax(420px,1.15fr)] lg:items-center">
          <div className="max-w-xl">
            ...
            <h1 className="mt-5 text-3xl font-black tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
              Plaquette Teffilin en 6 étapes
            </h1>
            <p className="mt-5 text-base leading-7 text-slate-600 sm:text-lg">
              Un support clair et illustré pour apprendre à mettre les Teffilin, étape par étape, avec les bénédictions essentielles.
            </p>
            ...
            <div className="mt-7 rounded-2xl border border-orange-200 bg-white/80 p-4 text-sm leading-6 text-slate-700 shadow-sm backdrop-blur">
              Une plaquette pédagogique et pratique, idéale pour accompagner chaque personne simplement dans l’accomplissement de cette mitsva.
            </div>
          ...
          <BoutiqueImageCarousel images={TEFFILIN_IMAGES} label="Présentation de la plaquette Teffilin en six étapes" />
        </div>
      </section>
    </div>
  );
