...
const FEATURES = [
  ...
  {
    label: "Emails & avis Google connectés",
    description: "Avis client, email urgent ou demande importante : EasyCom AI vous alerte et vous aide à répondre rapidement en un clic.",
    icon: MessageCircle,
    tone: "bg-emerald-50 text-emerald-700 border-emerald-100",
  },
  {
    label: "Clip Vidéo",
    description: "Transformez vos photos et vidéos en clip professionnel en quelques secondes.",
    icon: Clapperboard,
              ...
              {[
                {
                  ...
                  text: "Répondez vite aux demandes importantes avec un brouillon prêt à envoyer.",
                  icon: Clock3,
                  tone: "bg-blue-50 text-blue-700 border-blue-100",
                },
                {
                  title: "Priorités intelligentes",
                  text: "EasyCom AI détecte l'urgence des emails et avis pour vous faire gagner du temps.",
                  icon: RefreshCw,
                  tone: "bg-emerald-50 text-emerald-700 border-emerald-100",
                },
                {
                  title: "Publications multicanal",
                  text: "Préparez un message une fois et adaptez-le rapidement pour chaque canal.",
                  icon: BellRing,
                  tone: "bg-amber-50 text-amber-700 border-amber-100",
                },
