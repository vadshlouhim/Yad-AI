...
export const metadata: Metadata = {
  ...
  description: "Politique de confidentialité de EasyCom AI.",
};
        ...
        <div className="mt-6 space-y-6">
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              EasyCom AI collecte les informations nécessaires à la création et à la gestion d&apos;un
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              Lorsque vous connectez Facebook ou Instagram, EasyCom AI utilise l&apos;autorisation OAuth
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              ...
              contacts ne disposent pas d&apos;accès administrateur à EasyCom AI.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              EasyCom AI ne vend pas les données personnelles. Certaines données peuvent être transmises
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              ...
              en contactant l&apos;équipe EasyCom AI. Vous pouvez également déconnecter les canaux sociaux
