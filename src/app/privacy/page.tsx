...
export const metadata: Metadata = {
  ...
  description: "Politique de confidentialité de EasyCom IA.",
};
    ...
    <main className="min-h-screen bg-slate-50 px-4 py-10 text-slate-800 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <div className="mt-6 space-y-6">
          <div>
            <p className="text-sm font-semibold uppercase tracking-wide text-blue-600">EasyCom IA</p>
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              EasyCom IA collecte les informations nécessaires à la création et à la gestion d&apos;un
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              Lorsque vous connectez Facebook ou Instagram, EasyCom IA utilise l&apos;autorisation OAuth
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              ...
              contacts ne disposent pas d&apos;accès administrateur à EasyCom IA.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              EasyCom IA ne vend pas les données personnelles. Certaines données peuvent être transmises
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              ...
              en contactant l&apos;équipe EasyCom IA. Vous pouvez également déconnecter les canaux sociaux
