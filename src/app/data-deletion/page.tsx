...
export const metadata: Metadata = {
  ...
  description: "Instructions pour demander la suppression des données EasyCom IA.",
};
        ...
        <div className="mt-6 space-y-6">
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              Vous pouvez demander la suppression de votre compte EasyCom IA, de votre communauté, de
          ...
          <section className="space-y-2">
            ...
            <p className="leading-7">
              Vous pouvez également révoquer l&apos;accès de EasyCom IA depuis votre compte Meta ou depuis
              les paramètres de l&apos;application EasyCom IA dans la section Canaux. La révocation supprime
