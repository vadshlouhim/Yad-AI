...
const METHOD_POINTS = [
  {
    ...
    description: "EasyCom AI apprend votre métier, votre ton, vos habitudes et vos préférences pour créer une communication qui vous ressemble.",
  },
  {
  ...
  },
  {
    ...
    description: "EasyCom AI vous aide à rester visible avec des publications et automatisations programmées au bon moment.",
  },
  {
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            <Image src="/easycom-ai-logo.png" alt="Logo EasyCom AI" width={32} height={32} className="rounded-lg" />
            <div className="leading-tight">
              <p className="font-black text-slate-950">EasyCom AI</p>
