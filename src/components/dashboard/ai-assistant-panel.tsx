...
const QUICK_PROMPTS = [
  ...
  { label: "Vœux de fête", prompt: "Génère des voeux pour la prochaine fête juive" },
      ...
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-xl bg-white shadow-2xl z-50 flex flex-col">
        ...
        <div className="flex items-center gap-3 p-4 border-b border-slate-200 bg-slate-900">
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-white">Assistant EasyCom IA</p>
        ...
        <div className="p-4 border-t border-slate-200 bg-white">
          <div className="flex gap-2 items-end">
            <textarea
              ...
              placeholder="Demandez à EasyCom IA de générer un contenu…"
              rows={2}
