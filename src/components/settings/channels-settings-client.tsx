    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="rounded-xl bg-blue-50 border border-blue-200 p-4 flex items-start gap-3">
        ...
        <p className="text-sm text-blue-700">
          Connectez vos canaux pour publier directement depuis EasyCom AI. Les canaux non connectés
                    ...
                    {info?.authType === "oauth" ? (
                      <div className="space-y-3">
                        <p className="text-sm text-slate-600">
                          Connectez-vous via OAuth Meta. Une fois le compte connecté, EasyCom AI pourra publier sur la page Facebook ou le compte Instagram professionnel associé.
                        </p>
                        {channel?.isConnected ? (
                      ...
                      <div className="rounded-xl bg-amber-50 border border-amber-200 p-3 flex items-start gap-2">
                        ...
                        <div className="text-sm text-amber-700">
                          ...
                          <p className="text-xs mt-1">
                            ...
                            EasyCom AI génère le texte optimisé avec un lien <code>wa.me</code> à partager.
                          </p>
                        </div>
                      </div>
                    )}
