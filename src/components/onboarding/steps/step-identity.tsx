  ...
  return (
    <Card className="shadow-md">
      <CardHeader className="pb-4">
        ...
        <CardTitle className="text-xl">IdentitÃ© de votre communauté</CardTitle>
        <CardDescription>
          Ces informations seront utilisÃ©es par l&apos;IA pour personnaliser tous vos contenus.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <option value="Israel">IsraÃ«l</option>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-slate-700">
              <Phone className="size-3.5 inline mr-1" />TÃ©lÃ©phone
            </label>
            <input
              type="tel"
              value={data.phone}
